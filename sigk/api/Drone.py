...
class Drone():
	...
	def auth(self):
		...
		usr = 'drone'
		pswd = 'vanguard'
		data = {'username': usr, 'password':pswd}
		auths =(usr, pswd)
		...
		r = requests.put(url, headers=headers, auth=auths, verify=False)
		print r
	...
	def setHead(self, tHead):
		...
		url = self.url + path
		data = {"value": 145.00,  "source": "actisense.204",}
