        ...
        <div class="content-left">
            <ul class="side-nav">
                ...
                <li><a href="https://github.com/SignalK/freeboard-sk/" target="_fb">
                    <i class="fi-social-github"></i> GitHub</a></li>
            </ul>
        </div>
        <div class="content-right">
            ...
            <div class="panel" id="top">
                ...
                <p>Freeboard is an Openlayers based chart plotter that uses
                    ...
                    <ul>
                        ...
                        <li><b>Route and Waypoint</b> List and filter resources, drop waypoints, 
                            draw routes, set active route and import from GPX files.
                        </li>
                        <li><b>Anchor Watch:</b> and Depth alarms (visual and sound).</li>
                        <li><b>Instrument Panel:</b> allows you to select from the apps 
                            installed on your Signal K server for display.
                        </li>
                        <li><b>AIS</b> target display.</li>
                    </ul>
                </p> 
            ...
            <div class="panel" id="server">
                ...
                <p>Freeboard is a "stateless" application which can be used concurrently at multiple stations 
                    ...
                    <ul>
                        <li>
                            <i>reources/routes</i> and <i>resources/waypoints</i> - 
                        ...
                        <li><i>navigation/course/activeRoute</i> - Serve and accept <i>href</i> & <i>startTime</i> values 
                            to allow a route to be set as active. It is expected that the server will initiate 
            ...
            <div class="panel" id="display">
                ...
                <p>
                    ...
                    and other vessels <img src="../img/ais_active.png" style="height:20px;"/>(via AIS).<br>
                    ...
                    <li class="nobullet"><img src="./img/north_up.png"/>
                        <b>Heading / North Up:</b>
                        Toggles between <i>Heading / North Up</i> mode.
                    </li>                        
                    <li class="nobullet"><img src="./img/follow_vessel.png"/>
                    ...
                    <li class="nobullet"><img src="./img/centre_vessel.png"/>
                        <b>Centre Vessel on screen:</b> 
                        <i>Note: This option is disabled when vessel position is not available.</i>
                    </li>     
                    <li class="nobullet"><img src="./img/more.png"/>
                        <b>More Actions:</b>
                        Menu containing options to:
                        <b>Show / Hide AIS Targets</b> and
                        <b>Clear Vessel Trail</b>
                    </li>         
                    <li class="nobullet"><img src="./img/instrument_panel.png"/>
                        <b>Instrument panel:</b> The instrument panel can contain any WebApp installed on
                        the Signal K server.<br>
                        <i>The default instruments shown are <b>@signalk/instrumentpanel</b></i><br>
                        You can select which application to display from the 
                ...
                <p>
                    ...
                    lines are displayed with the vessel when the information is available.<br>
                    <img src="./img/vessel_lines.png" style="height:80px;"/>
                </p>
                <p>
                    <img src="../img/ais_active.png" style="height:20px;"/>
                    <b>Active AIS Target:</b> displays the current position and heading 
                    ...
                    <b>Inactive AIS Target:</b> displays the last received position and heading 
                    for an AIS target for which
                    an update has NOT been received for more than 6 mins.<br>
                    <i>Note: AIS Targets are removed from display after there has been no 
            ...
            <div class="panel" id="resources">
                ...
                <p>
                    ...
                    <li class="nobullet"><img src="./img/routes.png"/>
                        <b>Routes:</b>
                    ...
                    <div style="display:flex;">
                        ...
                        <div style="padding-left:15px;">
                            ...
                            <li><b>Activate: </b> Clicking this button sends a message to the server to set 
                                this route as the <i>Active Route</i>.
                            </li>
                            <li><b>Properties</b> Click the widget icon to edit route Name and Description.</li> 
                        </div>
                    </div>       
                    <br>                                    
                    <li class="nobullet"><img src="./img/waypoints.png"/>
                        <b>Waypoints:</b>
                    ...
                    <div style="display:flex;">
                        ...
                        <div style="padding-left:15px;">
                            ...
                            <li><b>Properties</b> Click the widget icon to edit waypoint Name and Description.</li> 
                        </div>
                    </div>  
                    <br>
                    Additionally, you can click on both Routes and Waypoints to display
                    an information window available actions.<br>
                    <img src="./img/route_popover.png"/>&nbsp;&nbsp;
                    <img src="./img/wpt_popover.png"/>
                    <br>&nbsp;<br>                   
                    <li class="nobullet"><img src="./img/draw.png"/>
                        <b>Draw Menu:</b>
                        The Draw menu is where you will find options to:
                        <li>Draw a Route</li>
                        <li>Add Waypoint at the current Vessel position</li>
                        <li>Drop Waypoint on the map</b></li>
                        <li>Measure distances</li>
                    </li>  
                    <br>                  
                    <li class="nobullet"><img src="./img/charts.png"/>
                        <b>Charts:</b> 
                    ...
                    <br>                        
                    <li class="nobullet"><img src="../img/gpx_black.png" style="width:36px;"/>
                        <b>Load from GPX:</b>
            ...
            <div class="panel" id="settings">
                <h4><i class="fi-widget"></i> Settings</h4>
                <p>
                ...
                <p>
                    ...
                    <img src="./img/settings_display.png" style="height:170px;"/>
                    <ul>
                ...
                <p>
                    ...
                    <img src="./img/settings_units.png" style="height:100px;"/><br>
                    ...
                    <i>Metres</i> / <i>Feet</i>
                    <br>
                    <b>Preferred Heading</b>: <i>headingTrue</i> / <i>headingMagnetic</i><br>
                    Value used to display vessel heading when both are available.<br>
                </p>	   
                
                <p>
                    <b>SERVER:</b><br>
                    <img src="./img/settings_server.png" style="height:100px;"/>
                    <ul>
                        <li><b>Server Resource Updates</b>: 
                            Un-check this box if you want to use <i>UPDATES</i> messages to send 
                            information to the server rather than <i>PUT</i> requests.
                        </li>        
                    </ul>
                    This setting is <b>Checked</b> by default and should be left checked to ensure 
                    Freeboard can respond to the success / failure of an action on the server.<br>
                    
                    Un-checking this option will cause UPDATES messages to be sent, which essentially 
                    broadcasts the information and does not 
                    elicit a specific response from the Signal K server regarding the sucess or failure
                    of an operation.<br>
                    This option can be used when the Signal K server does not accept requests for 
                    the paths required for Freeboard functions.<br>
                </p>                
            </div>
